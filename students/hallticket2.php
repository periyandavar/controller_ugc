...
$get_current_sem_papers=mysqli_query($connect,"select sem".$student_semester." from `papers` where `reg_no`= '".$register_number."'");
?>
      ...
      <div class="card-header" align="center">
            ...
            <div class="row">
              ...
              <div oncontextmenu="return false;" onkeydown="return false;" onmousedown="return false;" class="col-md-12 mb-2" align="right">
                <!-- <img src="img/printer.svg" height="30px" width="50px" align="right" onclick="print_hallticket();" style="cursor: pointer; margin-top: 5px;"> -->Download Hallticket (Do not download it from mobile that does not valid)
                <img src="img/pdf.svg" height="30px" width="50px" align="right" onclick="get_pdf()" style="cursor: pointer; margin-top: 5px;">
...
<!-- Hall Ticket Form Container Starts -->
  <div class="container" id="print_claim_table">
    ...
    <div class="logo" id="box">
      <!-- <center> -->
      <img src="" alt="clg logo" width="100" height="100">
      <!-- </center> -->
    </div>
    ...
    <?php 
        if(mysqli_num_rows($get_arrear_papers)>0):
        $i=2;
        while($arrear_papers=mysqli_fetch_array($get_arrear_papers)):
    ?>
    <div class="container_4section_<?php echo $i; ?>">
  &nbsp
  </div>
    <div class="grs-22 gre-23 container_4section_<?php echo $i; ?>" id="box_1"> <center> <strong><?php echo $arrear_papers['subject_code'] ?></strong> </center> </div>
    <?php
        $i++;
        endwhile;
    endif;
    ...
    <div class="container_9section_6" id="box"><center id="sine"><img oncontextmenu="return false;" id="sign" onkeydown="return false;" onmousedown="return false;" src="" alt="clg logo" width="205" height="75"></center></div>
...
code='<img oncontextmenu="return false;" onkeydown="return false;" onmousedown="return false;" src="" width="205" height="75">';
          $('#sine').empty();
          $('#sine').html(code);
