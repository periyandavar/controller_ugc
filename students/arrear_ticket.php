...
if($student_data['ap_flag']==1 )
 ...
 if($student_data['hallticket_stat']==1 )
  echo '<script>window.location.replace("hallticket.php");</script>';
...
// $get_papers = mysqli_query($connect,"select subject_code, subject_name,type from `mark_details` where register_no='".$register_number."' and `result`='RA'");
...
<!-- Hall Ticket Form Container Starts -->
  <div class="container" id="print_claim_table">
    ...
    <div class="exam-header" id="box">
      <center>
      REPEAT EXAMINATIONS, <span style="color:black"><?php echo $exam_year['appear_month']; ?></span>
      </center>
    </div>
...
<div class="grs-22 gre-23 container_4section_1" id="box_1" style="border-right:1px solid black"><strong>Arrear Papers</strong></div>
    ...
    ?>
    <div class="grs-22 gre-23 container_4section_<?php echo $i; ?>" id="box_1"> <center>  <strong><?php echo $paper_list[$j] ?></strong> </center> </div>
    <?php
      $i++;
      $j++;
      endwhile;
