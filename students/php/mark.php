...
session_start();
	...
	if($op=="get_ticket")
	{
      ...
      {
      	$res['err'] = 10;
					$res['result'] = 'You are not permitted to get the Marksheet Please contact the controller of exam for more details...!';
					$res['path'] = "";
      }
...
else if ((file_exists("../"."../PG/php/output/marksheet/".$row['dept_code']."/".$_POST['semester']."/".$_SESSION['admin'].".pdf"))) {
	$path="../PG/php/output/marksheet/".$row['dept_code']."/".$_POST['semester']."/".$_SESSION['admin'].".pdf";
					$res['err'] = 0;
					$res['result'] = 'Fetching Successfully';
					$res['path'] = $path;
				} else {
					$res['err'] = 10;
					$res['result'] = 'Marksheet is not yet ready for the Semester - '.$_POST['semester'];
					$res['path'] = "";
				}
