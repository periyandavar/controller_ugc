...
// Main program
function send($mail1,$user,$id){ 
	// echo $mail;
$ot=(generateNumericOTP(7));
//echo$ot;
$sub='Recover your clg COE Account';
/*$mesg='Hello '.$user.' The One Time Password to recover your clg COE Account is given below , use it carefully,..|
   ID : ' .$id.'
   OTP : '.$ot.'
...
$mesg='<table><tbody><tr><td bgcolor="#ececec"> 
      <table style="font-family:Arial,Helvetica,sans-serif;max-width:620px" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
       <tbody>
        <tr> 
         <td width="100%" bgcolor="#ffffff"> 
           
          <table style="max-width:620px" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
           <tbody> 
            <tr> 
             <td style="border-top:6px solid #0073e6;padding:0 10px"> 
              <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
               <tbody>
                <tr> 
                 <td style="padding:20px 0;border-bottom:5px solid #ffffff;line-height:0" align="center">
                 	<img src="https://ci5.googleusercontent.com/proxy/m9Rklv2sYIEGCC4BW7dlzs6bsAMzAJwLAjfmD08JfqqF9DOu0nkRfvFrJDo8CiIU4Ncn7ctIS0vFsfHH6I8=s0-d-e1-ft#https://anjaccoe.org/students/img/clg.png" style="width:100px;height:100px" class="CToWUd">
          ...
          <table style="max-width:600px" padding_top="20px" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
           <tbody>  
            <tr> 
             <td> 
              <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
               <tbody>
                <tr> 
                 <td style="font-size:20px;font-family:Arial,Helvetica,sans-serif;padding:40px 30px 30px 30px" align="center">
                  <div style="color:#8e8e8e;font-size:16px;margin-bottom:12px">
                   Hi '.$user.',
                  </div>Recover your clg COE Account
                  <br>
                </td> 
                </tr> 
               </tbody>
         ...
         <td style="color:#0040ff;background-position:right top;background-repeat:no-repeat;background-position:fixed;background-size:100%;background-size:cover;padding:58px 0px 0 0px;text-align:center" width="100%" bgcolor="#ffffff"> 
           
          <table style="max-width:620px" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"> 
           <tbody> 
            <tr> 
             <td style="padding:17px 20px 26px 20px;text-align:left" bgcolor="#0073e6"> <br><br>
              <table width="100%" cellspacing="0" cellpadding="0" border="0"> 
               <tbody>
                <tr> 
                 <td style="color:#ffffff;font:20px Arial">The One Time Password to recover your clg COE Account is given below , use it carefully...
                 <br>
                 <br>
                 ID : '.$id.'
                 <br>
                ...
                <tr><td style="font:12px/165% Arial;color:#ffffff;padding:10px" align="left">The Password is valid Only for one time use and will expire soon so use it as early as possible.Use this OTP to access you account to change the password... 
                 	<br>
                 	<br>
                 Thank you '.$user.' for being on Active member with us...</td> 
...
$from='ugcontroller@anjaccoe.org';
$to=$mail1;
$headers="From:".$from;
  ...
  $mail->setFrom('controller@anjaccoe.org', 'clg UG Control Office');
  $mail->addAddress($to);     // Add a recipient
  $mail->isHTML(true);               // Set email format to HTML
  $mail->Subject = 'Recover your clg COE Account';
  $mail->Body    = $mesg;
if($mail->send())
...
{  
    if(isset($_POST['id']))
    {
				 ...
				 $sql='SELECT email_id,register_no,name,pass From student_master Where register_no="'.$_POST['id'].'"';
...
<body onload="countdown();"> 
    <div> 
        ...
        <input id="seconds" type="text" style="width: 20px; 
				 ...
				 {
				            $msg=send($mail,$user,$_POST['id']);
				           if($msg!='0') {
    $_SESSION['ot']=$msg;
$msg="OTP is Sent to ".$mail ." id successfully...!! <br> Please, Kindly Check Your Mail ID !!";    $otp='y';
}
else
{
    $msg="Error in Sending Mail Due To Some Network Problem !!";
}
	 ...
	 if($pass==$_SESSION['ot'])
	 {
	 	  $msg="The OTP is Success !!";
	 	  $sql=mysqli_query($connect,'UPDATE student_master set pass="'.$_POST['pass2'].'"Where register_no="'.$_SESSION['id'].'"');
...
<head>
    ...
    <title> clg COE | PASSWORD RECOVERY</title>
    <meta
      name="viewport"
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    ...
    <meta name="title" content="clg COE Panel login" >
    <meta name="keywords" content="clg,cs,COE,computerscience,AJ,login" >
    <meta name="description" content="this page is for clg COE Account password recovery">
...
/*# sourceMappingURL=style.css.map */</style>
    ...
    <script>
function toast(msgType,msg){
    // alert(msg);
    if(msgType == "Error"){
        var alertError=document.getElementById('msgFail');
...
<div  id="loading" style="background-color:#FDFDFF;opacity:1;position:'absolute'">
  <div  style="background: url('pre.gif') no-repeat center center;width:100%;height:100%">
  </div>
</div>

<div class="sufee-alert alert with-close alert-success  fade show" id="alertSuccess" style="display:none">
...
<div class="sufee-alert alert with-close alert-danger  fade show" id="alertFail" style="display:none">
            ...
            <div class="login-content ">
                <div class="login-form bg-dark">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <h3 class='text-light'><i class='fa fa-key mr-3'></i> Student Account Recovery</h3>
                        ...
                        <div class="msg">
                          ...
                          ?>
												...
												?>
													...
													<div class="form-group ">
													<label class='text-primary text-capitalize'>User ID</label>
													<input type="text" name="id" id="username" class="form-control" placeholder="User ID" required>
												...
												<div class="form-group ">
												<label class='text-primary text-capitalize'>OTP</label><br>
												<input type="password" name="pass" id="myInput" placeholder="Enter OTP"><br> 
												<label class='text-primary text-capitalize'>New Password</label>
	<br>											<input type="password" name="pass2" id="myInput2" placeholder="Enter OTP"> 
												</div>
                        ...
                        <div class="form-group text-center">
                            <button type="submit" id="submit" class="btn btn-primary btn-sm col-md-3" name="Login">
														<?php 
