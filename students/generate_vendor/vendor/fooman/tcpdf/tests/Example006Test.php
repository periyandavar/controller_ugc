...
class Example006Test extends Common
{

    const EXAMPLE_NR = '006';
    const NR_PDF_PAGES = 6;

    public function testPdfOutput()
    {

        $this->markTestIncomplete('Font rendering different (missing characters) - also emits Warning "Warning: Invalid 0.0 font scale given for Tf"');
...
List example:
<ol>
    <li><img src="./tests/images/logo_example.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
    <li><b>bold text</b></li>
...
<img src="./tests/images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="./tests/images/tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="./tests/images/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
<tr><td><img src="./tests/images/logo_example.png" border="0" height="41" width="41" /></td></tr>
<tr style="text-align:left;"><td><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr style="text-align:center;"><td><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr style="text-align:right;"><td><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
<tr><td style="text-align:left;"><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr><td style="text-align:center;"><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr><td style="text-align:right;"><img src="./tests/images/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
</table>';
