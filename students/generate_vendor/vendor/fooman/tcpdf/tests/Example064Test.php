...
class Example064Test extends Common
{
...
// print some graphic content
        $pdf->Image('tests/images/image_demo.jpg', 155,  30, 40, 40, 'JPG', '', '', true);
        $pdf->Image('tests/images/image_demo.jpg',  15, 230, 40, 40, 'JPG', '', '', true);
